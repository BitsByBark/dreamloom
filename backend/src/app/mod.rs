...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::misc::build_info::get_build_info,
            crate::misc::fs::list_directory,
            crate::misc::fs::list_child_directories_by_github_push,
            ...
            crate::css_vars::read_css_vars,
            crate::css_vars::write_css_var,
            crate::css_vars::delete_css_var,
            crate::named_classes::extract_named_class,
