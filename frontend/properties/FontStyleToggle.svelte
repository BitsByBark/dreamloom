<script lang="ts">
  ...
  import { FONT_STYLE_TOGGLES } from "./typography-fields";
  ...
  function pick(next: (typeof FONT_STYLE_TOGGLES)[number]["value"]) {
...
<div class="prop-toggle-group" role="group" aria-label="Font style">
  {#each FONT_STYLE_TOGGLES as option (option.value)}
    <button
      type="button"
