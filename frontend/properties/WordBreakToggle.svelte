<script lang="ts">
  ...
  import { WORD_BREAK_TOGGLES } from "./typography-fields";
  ...
  function pick(next: (typeof WORD_BREAK_TOGGLES)[number]["value"]) {
...
<div class="prop-toggle-group" role="group" aria-label="Word break">
  {#each WORD_BREAK_TOGGLES as option (option.value)}
    <button
      type="button"
