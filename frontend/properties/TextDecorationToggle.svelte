<script lang="ts">
  ...
  import { TEXT_DECORATION_TOGGLES } from "./typography-fields";
  ...
  function pick(next: (typeof TEXT_DECORATION_TOGGLES)[number]["value"]) {
...
<div class="prop-toggle-group" role="group" aria-label="Text decoration">
  {#each TEXT_DECORATION_TOGGLES as option (option.value)}
    <button
      type="button"
