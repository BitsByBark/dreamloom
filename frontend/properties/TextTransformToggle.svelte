<script lang="ts">
  ...
  import { TEXT_TRANSFORM_TOGGLES } from "./typography-fields";
  ...
  function pick(next: (typeof TEXT_TRANSFORM_TOGGLES)[number]["value"]) {
...
<div class="prop-toggle-group" role="group" aria-label="Text transform">
  {#each TEXT_TRANSFORM_TOGGLES as option (option.value)}
    <button
      type="button"
